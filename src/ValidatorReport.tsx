        ...
        <Grid container spacing={2}>
          <Grid item lg={12}>
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              ...
              <Button
                style={{ display: "none", fontSize: 12, alignSelf: "center" }}
                onClick={() => setIsModalOpen(true)}
              >
                <Edit style={{ fontSize: 12, alignSelf: "center" }} /> Backend
              </Button>
            </div>
            <Dialog
              style={{ minWidth: 275 }}
            ...
            >
              ...
              <FormControl style={{ margin: 12 }}>
                <Select
                  ...
                  value={backendUrl}
                  onChange={(e) =>
                    setBackendUrl(e.target.value as unknown as string)
                  }
                >
                  <MenuItem value={"https://validators.joystreamstats.live"}>
                    validators.joystreamstats.live
                  </MenuItem>
                  <MenuItem value={"https://joystream-api.herokuapp.com"}>
                    joystream-api.herokuapp.com
                  </MenuItem>
                  <MenuItem value={"http://localhost:3500"}>
                    localhost:3500
                  </MenuItem>
                </Select>
              </FormControl>
